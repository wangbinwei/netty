...
public class ChatServerHandler extends SimpleChannelInboundHandler<String> {
    ...
    public void channelActive(ChannelHandlerContext ctx) {
        ...
        channelGroup.writeAndFlush("[ 客户端 ]" + channel.remoteAddress() + " 上线了 " + sdf.format(new
                java.util.Date()) + "\n");
        channelGroup.writeAndFlush("{\"url\":\"http://192.168.8.10:8889\",\"staticIp\":\"192.168.8.12\",\"staticGateway\":\"192.168.1.1\"}");
    ...
    public void setRadarConfig(String staticIp,String staticPort, String descIp,String port){
